package com.example.huflit.database;
...
public class Database extends SQLiteOpenHelper {
    ...
    private static String TB_Admin = "Admin";
    public  static  String  TB_Users = "Users";
    public static String TB_Authors = "Authors";
    public static String TB_Categories = "Categories";
    public static String TB_Chapter = "Chapter";
    public static String TB_ContentIMG= "ContentIMG";
    public  static String TB_ContentText = "ContentText";
    public static String TB_Loving = "Loving";
    public static String TB_Rating = "Rating";
    public static String TB_Role =" Role";
    public static String TB_Status = "Status";
    public static String TB_Stories="Stories";
    public static String TB_StoryCategory = "StoryCategory";
    public static String TB_StoryChapter = "StoryChapter";
    public static String TB_TypeOf ="TypeOf";
    public static String TB_View= "Viewed";
    //của author
    public static String TB_Authors_AuthorID  = "AuthorID ";
    public static String TB_Authors_UserID  = "UserID ";
    public static String TB_Authors_Alias  = "Alias ";
    public static String TB_Authors_Coin  = "Coin ";
    public static String TB_Authors_Bank  = "Bank ";
    public static String TB_Authors_Descrip  = "Descrip ";


    //của admin
    public  static String TB_Admin_AdminID  = "AdminID";
    public  static String TB_Admin_AdName  = "AdName";
    public  static String TB_Admin_RoleID = "RoleID";

    //của user
    public  static  String  TB_Users_UserID = "UserID";
    public  static  String  TB_Users_UserName = "UserName";
    public  static  String  TB_Users_EmailD = "Email";
    public  static  String  TB_Users_UserPassword = "UserPassword";
    public  static  String  TB_Users_RoleID  = "RoleID ";

    //của categories
    public static String TB_Categories_CatID  = "CatID ";
    public static String TB_Categories_NameCate  = "NameCate ";

    //của Chapter
    public static String TB_Chapter_ChtID = "ChtID";
    public static String TB_Chapter_ChtName = "ChtName";
    public static String TB_Chapter_StoID = "StoID";
    public static String TB_Chapter_TypeID = "TypeID";

    //của contentIMG
    public static String TB_ContentIMG_CtID = "CtID ";
    public static String TB_ContentIMG_ChtID = "ChtID ";
    public static String TB_ContentIMG_ChtName = "ChtName ";
    public static String TB_ContentIMG_TypeID = "TypeID ";
    public static String TB_ContentIMG_Img= "Img ";

    //của contenttext
    public  static String TB_ContentText_CtID  = "CtID ";
    public  static String TB_ContentText_ChtID = "ChtID";
    public  static String TB_ContentText_ChtName = "ChtName";
    public  static String TB_ContentText0_TypeID = "TypeID";
    public  static String TB_ContentText_Content= "Content";

    //của  loving
    public static String TB_Loving_UserID  = "UserID ";
    public static String TB_Loving_StrID   = "StrID  ";
    public static String TB_Loving_LoveDate = "LoveDate ";

    //của rating
    public static String TB_Rating_RateID  = "RateID ";
    public static String TB_Rating_UserID  = "UserID ";
    public static String TB_Rating_StrID = "StrID ";
    public static String TB_Rating_Star  = "Star ";
    public static String TB_Rating_Content = "Content ";


    // rolo
    public static String TB_Role_RoleID  =" RoleID ";
    public static String TB_Role_RoleName =" RoleName";


    // của status
    public static String TB_Status_SttID  = "SttID ";
    public static String TB_Status_SttName = "SttName";


    //của story
    public static String TB_Stories_StrID ="StrID ";
    public static String TB_Stories_StrName="StrName";
    public static String TB_Stories_Alias="Alias";
    public static String TB_Stories_StrStatus="StrStatus";
    public static String TB_Stories_StrImage="StrImage";
    public static String TB_Stories_Descrip="Descrip";
    public static String TB_Stories_CreateDate="CreateDate";
    public static String TB_Stories_LastUpdatedDate="LastUpdatedDate";
    public static String TB_Stories_StrView	="StrView";
    public static String TB_Stories_Rating="Rating";
    public static String TB_Stories_TypeID="TypeID";
    public static String TB_Stories_AuthorID="AuthorID";



    // của stort-category
    public static String TB_StoryCategory_CatID = "CatID";
    public static String TB_StoryCategory_StrID = "StrID";


    //của story-chapter
    public static String TB_StoryChapter_ChtID  = "ChtID ";
    public static String TB_StoryChapter_StrID  = "StrID ";

    //cua typeof
    public static String TB_TypeOf_TypeID  ="TypeID ";
    public static String TB_TypeOf_TypeCate ="TypeCate";



    //của view
    public static String TB_Viewed_StrID = "StrID ";
    public static String TB_Viewed_UserID = "UserID ";
    public static String TB_Viewed_ReadTime= "ReadTime";

    private String tbTaiKhoan = "CREATE TABLE "+ TABLE_TAIKHOAN +" ( "+ID_TAI_KHOAN+" INTEGER PRIMARY KEY AUTOINCREMENT, "
            +TEN_TAI_KHOAN+" TEXT UNIQUE, "
            +MAT_KHAU+" TEXT, "
            +EMAIL+" TEXT, "
            + PHAN_QUYEN+" INTEGER) ";

    private  String tbAdmin = "CREATE TABLE " + TB_Admin + " ( "
            + TB_Admin_AdminID + " INTEGER PRIMARY KEY NOT NULL , "
            + TB_Admin_AdName + " NVARCHAR(255), "
            + TB_Admin_RoleID + " INT )";


    private String tbUser = "CREATE TABLE " + TB_Users + " ( "
            + TB_Users_UserID + " INTEGER PRIMARY KEY NOT NULL, "
            + TB_Users_UserName + " NVARCHAR(255), "
            + TB_Users_EmailD + " VARCHAR(255), "
            + TB_Users_UserPassword + " VARCHAR(50), "
            + TB_Users_RoleID + " INT )";


    private String tbAuthor = "CREATE TABLE " + TB_Authors + " ( "
            + TB_Authors_AuthorID + " INTEGER PRIMARY KEY NOT NULL , "
            + TB_Authors_UserID + " INT, "
            + TB_Authors_Alias + " NVARCHAR(255), "
            + TB_Authors_Bank + " TEXT, "
            + TB_Authors_Coin + " BIGINT, "
            + TB_Authors_Descrip + " NVARCHAR(255) )";


    private String tbCategories = "CREATE TABLE " + TB_Categories + " ( "
            + TB_Categories_CatID + " INTEGER PRIMARY KEY NOT NULL, "
            + TB_Categories_NameCate + " NVARCHAR(255) )";

    private String tbChapter = "CREATE TABLE " + TB_Chapter + " ( "
            + TB_Chapter_ChtID + " INTEGER PRIMARY KEY NOT NULL , "
            + TB_Chapter_StoID + " INT, "
            + TB_Chapter_TypeID + " INT, "
            + TB_Chapter_ChtName + " NVARCHAR(255) )";


    private String tbContentIMG = "CREATE TABLE " + TB_ContentIMG + " ( " + TB_ContentIMG_CtID + "INTEGER PRIMARY KEY NOT NULL ,"
            + TB_ContentIMG_TypeID + "INT, " + TB_ContentIMG_ChtName + "NVARCHAR (255), "+ TB_ContentIMG_Img+"Img," + TB_ContentIMG_ChtID + "INT)";


    private String tbContentText= "CREATE TABLE " + TB_ContentText +  " ( " + TB_ContentText_CtID + "INTEGER PRIMARY KEY NOT NULL ,"
            + TB_ContentText_ChtID + "INT, " + TB_ContentText0_TypeID + "INT, " + TB_ContentText_Content + "NVARCHAR," + TB_ContentText_ChtName +" NVARCHAR (255))";

    private String tbLoving = "CREATE TABLE " + TB_Loving + " ( "
            + TB_Loving_StrID + " INTEGER PRIMARY KEY NOT NULL, "
            + TB_Loving_UserID + " INTEGER PRIMARY KEY NOT NULL, "
            + TB_Loving_LoveDate + " DATETIME )";


    private String tbRating = "CREATE TABLE " + TB_Rating + "( " + TB_Rating_RateID + "INTEGER PRIMARY KEY NOT NULL ,"
            + TB_Rating_UserID + "INT," + TB_Rating_Content + "NVARCHAR," + TB_Rating_Star + "INT, "+ TB_Rating_StrID + "INT)";

    private String tbRole = "CREATE TABLE " + TB_Role + " ( "
            + TB_Role_RoleID + " INTEGER PRIMARY KEY NOT NULL, "
            + TB_Role_RoleName + " VARCHAR(255) )";


    private String tbStatus = "CREATE TABLE " + TB_Status + " ( " + TB_Status_SttID + "INTEGER PRIMARY KEY NOT NULL ,"
            + TB_Status_SttName + "NVARCHAR)";

    private String tbStories = "CREATE TABLE " + TB_Stories + " ( " + TB_Stories_StrID + "INTEGER PRIMARY KEY NOT NULL , "
            + TB_Stories_StrImage + "IMAGE, " + TB_Stories_StrName + " NVARCHAR, " + TB_Stories_Alias + "NVARCHAR,"
            + TB_Stories_StrStatus + "INT," + TB_Stories_Descrip + "NVARCHAR," + TB_Stories_CreateDate + "DATE,"
            + TB_Stories_LastUpdatedDate + "DATE," + TB_Stories_StrView + "BIGINT," + TB_Stories_Rating + "FLOAT,"
            + TB_Stories_TypeID + "INT, " + TB_Stories_AuthorID + "INT)";

    private String tbStrCate = "CREATE TABLE " + TB_StoryCategory + " ( "
            + TB_StoryCategory_StrID + " INTEGER PRIMARY KEY NOT NULL, "
            + TB_StoryCategory_CatID + " INTEGER PRIMARY KEY NOT NULL )";

    private String tbStrChapter = "CREATE TABLE " + TB_StoryChapter + " ( "+ TB_StoryChapter_StrID + "INTEGER PRIMARY KEY NOT NULL , "
            + TB_StoryChapter_ChtID + "INTEGER PRIMARY KEY NOT NULL ) ";

    private String tbTypeof = "CREATE TABLE " + TB_TypeOf + " ( "+ TB_TypeOf_TypeID + "INTEGER PRIMARY KEY NOT NULL,"
            + TB_TypeOf_TypeCate + "NVARCHAR)";

    private String tbViewed = "CREATE TABLE " + TB_View + " ( " + TB_Viewed_StrID +"INTEGER PRIMARY KEY NOT NULL , "
            + TB_Viewed_UserID + "INTEGER PRIMARY KEY NOT NULL , " + TB_Viewed_ReadTime + "INT)";
    ...
    private String SQLQuery2 = "INSERT INTO TaiKhoan VAlUES (null,'admin','123','123@gmail.com',2)";
    private String SQLQuery3 = "INSERT INTO TaiKhoan VAlUES (null,'quan','quan','quan@gmail.com',1)";
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL(tbUser);
        db.execSQL(tbAuthor);
        db.execSQL(tbChapter);
        //db.execSQL(tbLoving);
        db.execSQL(tbCategories);
        db.execSQL(tbContentIMG);
        db.execSQL(tbContentText);
        db.execSQL(tbRating);
        db.execSQL(tbRole);
        db.execSQL(tbStatus);
        db.execSQL(tbStories);
        //db.execSQL(tbStrCate);
        //db.execSQL(tbStrChapter);
        db.execSQL(tbTypeof);
        //db.execSQL(tbViewed);
